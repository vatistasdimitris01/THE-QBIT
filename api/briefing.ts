...
const getBriefingPrompt = (date: Date, country?: string | null, category?: string | null): string => {
    ...
    **Δομή Απάντησης JSON**:
    ...
    4.  'stories': Ένας πίνακας με **ακριβώς 3** αντικείμενα ειδήσεων. Κάθε αντικείμενο πρέπει να έχει:
        ...
        *   'summary': Η σε βάθος ανάλυση 3-5 παραγράφων, με '\\n' για αλλαγή γραμμής.
        *   'importance': Ακέραιος 1-3.
        *   'annotations': Ένας πίνακας με 2-3 αντικείμενα, το καθένα με 'term', 'importance' (1-3), και 'explanation' (η λεπτομερής παράγραφος ανάλυσης).
